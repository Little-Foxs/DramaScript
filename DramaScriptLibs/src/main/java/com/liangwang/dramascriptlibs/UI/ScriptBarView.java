...
public class ScriptBarView extends RelativeLayout implements View.OnClickListener, View.OnTouchListener {

	private ScriptMainView tabBackView;
	...
	private ScriptMainView.OnAnimationEndListener onAnimationEndListener = new ScriptMainView.OnAnimationEndListener() {
	...
	public ScriptBarView(Context context) {
		this(context, null);
	}

	public ScriptBarView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void initView() {
		tabBackView = (ScriptMainView) findViewById(R.id.tabBackView);
