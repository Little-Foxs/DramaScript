...
public class FileDownloadTask extends AsyncTask<Void, Long, Boolean> {
    ...
    //下载过程中的回调
    private ScriptDownloadFileCallback callback;
    private String url;
    //目标文件
    private File target;
    //开始下载时间，用户计算加载速度
    ...
    public FileDownloadTask(String url, File target, ScriptDownloadFileCallback callback) {
        this.url = url;
        this.okHttpClient = ScriptOkhttp.getInstance().getOkHttpClient();
